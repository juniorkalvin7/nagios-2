...
while True:
  ...
  if "use" in l:
    ...
    print "centreon -u alvin -p abc@123 -o STPL -a add -v '%s;%s;%s'"%(name,service_description,use)
  ...
  if "check_command" in l:
    ...
    print "centreon -u alvin -p abc@123 -o STPL -a setparam -v '%s;%s;%s'"%(name,"check_command",check_command1)
    if "%s!"%check_command1 in l:
      ...
      print "centreon -u alvin -p abc@123 -o STPL -a setparam -v '%s;%s;!%s'"%(name,"check_command_arguments",check_command2)
