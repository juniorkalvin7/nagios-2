...
if len(args)<2:
  ...
  community=args[1]
try:
  valor=(commands.getoutput("/usr/bin/snmpwalk -t 100000 -v 1 -c %s %s:3401 .1.3.6.1.4.1.3495.1.3.1.7" %(community,str(host)))).split('Gauge32: ')[1]
except Exception,e:
...
print "Squid - Num Object Count - %s|squidstat=%s squidstatb=%s" % (valor,valor,valor)
