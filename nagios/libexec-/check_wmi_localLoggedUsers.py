...
#-----------------------------------------------------------------
#Autor: Wagner Dias.                                             |
#Descrição: lista os usuários conectados localmente.             |
#                                                                |
#-----------------------------------------------------------------
...
#print controle_nomes_local

if ((controle_nomes_local.count('Administrador')|(controle_nomes_local.count('Administrator'))) > 0):
	print "Administrador conectado Localmente."
	print "%s\n" %(corpo_local.replace('\n',''))
	sys.exit(1)
else:
	#if (len(controle_nomes_local) > 0):
		print "Numero de usuários conectados localmente: %s" %(len(controle_nomes_local))
	#else:
	#	print "Numero de usuários conectados localmente: 0"
