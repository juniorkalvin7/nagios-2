...
def topuser():
  ...
  corpo+="""var myChart = new FusionCharts("http://cmp.intechne.com.br/cmp/modules/cmp2otrs/MSBar3D.swf","""+\
  ...
  corpo+="""myChart.setDataXML("<chart baseFontSize='12' canvasBgAlpha='0' exportEnabled='1' exportAtClient='1' """+\
       ...
       """legendPosition='BOTTOM'><categories>"""
...
args = sys.argv[1:]
def helpmsg():
  print "Centreon Plugin\nGetDB Info 1.0 por GemayelLira"
